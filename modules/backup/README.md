...
Terraform module to create [AWS Backup](https://aws.amazon.com/backup/) plans.  AWS Backup is a fully managed backup service that makes it easy to centralize and automate the back up of data across AWS services:
...
module "aws_backup_example" {
  ...
  # Vault
  vault_name = "uk-devops-production-backup-main-vault"

  # Plan
  plan_name = "uk-devops-production-backup-main-plan"

  # Multiple rules using a list of maps
  rules = [
    {
      name              = "uk-devops-production-backup-main-rule-1"
      schedule          = "cron(0 12 * * ? *)"
    ...
    {
      name                = "uk-devops-production-backup-main-rule-2"
  ...
  # Tags
  tags = {
    Name        = "uk-devops-production-backup-main"
    Country     = "uk"
    Team        = "devops
    Environment = "production"
    Service     = "backup"
